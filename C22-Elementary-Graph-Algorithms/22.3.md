...
Clearly, there is a path from u to v in G. The bold edges are in the depth-first forest produced. We can see that d[u] < d[v] in the depth-Þrst search but v is not a descendant of u in the forest.
